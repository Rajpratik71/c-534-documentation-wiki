...
# Basic Concepts
##Microservice 
Microservice is a main part of the **<a href="http://app.c-534.io" target="_blank">c-534.io</a>** platform. Can connect to almost any REST API available. Basically a Microservice consists of 3 main parts: **Input Connector**, **Transormation** and **Output Connector**. Look at the diagram below to grasp a basic understanding:
